    ...
    def create_proximity_relations(self, actor1, actor2):
        for relation in self.proximity_rels:
            if self.euclidean_distance(actor1, actor2) <= relation[1]:
                #print("Calling create_proximity_relations", [actor1, self.euclidean_distance(actor1, actor2), actor2])
                return [[actor1, self.euclidean_distance(actor1, actor2), actor2]]
        return []
